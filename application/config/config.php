...
|--------------------------------------------------------------------------
*/
$config['website_name'] = ''; // FILL IN REQUIRED ex: My Website
$config['webmaster_email'] = ''; // FILL IN REQUIRED ex: user@mywebsite.com
...
|
*/
$config['prod_base_domain'] = ''; // FILL IN REQUIRED ex: mywebsite.com
$config['prod_base_url'] = 'http://' . $config['prod_base_domain'] . '/'; 
...
|--------------------------------------------------------------------------
*/
if ($_SERVER['HTTP_HOST'] != $config['prod_base_domain'])
    $config['app_mode'] = 'dev';
else
...
|
*/
$config['encryption_key'] = ""; // FILL IN REQUIRED ex: 46bnZ5AYpHTxVLd1TO9f13cj8HWw9tg6
